...
const skillsSection = {
  ...
  skills: [
    ...
    emoji("🛡️ Conception d'APIs sécurisées (JWT, OAuth2, Identity)"),
    emoji(
      "🌐 Développement d'interfaces utilisateur interactives et dynamiques pour applications web"
    )
  ],
...
const educationInfo = {
  ...
  schools: [
    ...
    },
    {
      schoolName: "IT University, Madagascar",
      logo: require("./assets/images/itu-logo.png"),
      subHeader: "Licence informatique, option développement",
      duration: "2021 - 2024",
      desc: "Mention Bien",
      descBullets: [
  ...
  experience: [
    {
      ...
      desc: "Stage académique",
      descBullets: [
        "Conception et développement du réseau social interne d'une université partenaire (ReactJS et NestJS)",
        "Conception, développement et maintenance de plusieurs sites (Java APJ : framework Java EE du BICI)",
        "Visites client pour suivi du projet, recueil des besoins et validation des évolutions."
      ]
    },
    {
      role: "",
      ...
      descBullets: [
        ...
        "Initiation au domaine RH, démarches administratives auprès des organismes compétents",
...
const resumeSection = {
  title: "CV",
  subtitle: "Soyez libre de télécharger mon CV",
...
const contactInfo = {
  ...
  subtitle:
    "Vous voulez discuter d’un projet ou simplement dire bonjour ? Ma messagerie est ouverte à tous.",
